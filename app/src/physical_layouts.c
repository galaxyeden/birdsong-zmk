...
#define ZMK_LAYOUT_INST(n)                                                                         \
    ...
    static const struct zmk_physical_layout const _CONCAT(_zmk_physical_layout_,                   \
        ...
        COND_CODE_1(UTIL_AND(IS_ENABLED(CONFIG_INPUT), UTIL_OR(DT_HAS_CHOSEN(zmk_matrix_input),    \
                                                               DT_INST_PROP_LEN(n, input))),       \
    ...
    COND_CODE_1(                                                                                   \
        UTIL_AND(IS_ENABLED(CONFIG_INPUT),                                                         \
                 UTIL_OR(DT_HAS_CHOSEN(zmk_matrix_input), DT_INST_PROP_LEN(n, input))),            \
